...
export const useSiteNavStyles = makeStyles({
  ...
  absoluteContainer: {
    backgroundColor: gitRulesTokens.colorNeutralBackground1,
    position: 'absolute',
    top: '0',
    minHeight: '100%',
    width: '100%',
  ...
  expandContainer: {
    width: '100%',
    marginBottom: gitRulesTokens.spacingVerticalM,
  },
  epandLink: {
    width: '100%',
    color: gitRulesTokens.g4gColorPrimaryGreen4,
    display: 'flex',
  ...
  link: {
    width: '100%',
    color: gitRulesTokens.g4gColorPrimaryGreen5,
    display: 'flex',
    alignItems: 'center',
    'text-decoration': 'none',
    ':hover, &.active': {
      backgroundColor: gitRulesTokens.g4gColorSecondaryGreen1,
      color: gitRulesTokens.g4gColorPrimaryGreen9,
    },
  },
  linkIconContainer: {
    width: '75px',
  ...
  linkIcon: {
    fontSize: gitRulesTokens.fontSizeBase600,
    '&.pinned': {
