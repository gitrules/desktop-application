...
export const IssuesPanel: FC = memo(function IssuesPanel() {
  ...
  const manage = useCallback(async () => {
    if (selectedIssue != null && selectedPolicy != null) {
      ...
      setSuccessMessage(
        [
          `Success. Issue #${selectedIssue.number}, ${selectedIssue.title}, is now marked to be managed by GitRules.`,
      ...
      {selectedIssue != null && (
        <div className={styles.selectedIssueArea}>
          ...
          <div className={styles.manageIssueFormArea}>
                      ...
                      <>
                        ...
                        <div>
                          ...
                          >
                            ...
                            Manage with GitRules using {selectedPolicy?.title}
                          </Button>
                        </div>
                      </>
                    )}
            ...
            {isManaged(selectedIssue) && (
              <strong>
                Managed with GitRules using {selectedIssue.policy?.title}
              </strong>
            )}
          </div>
