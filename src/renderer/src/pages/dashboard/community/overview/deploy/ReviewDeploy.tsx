...
export const ReviewDeploy: FC = memo(function ReviewDeploy() {
  ...
  const deploy = useCallback(async () => {
    ...
    setLoading(false)
    const message = [
      `Success. A GitRules community has been deployed for ${selectedOrg}/${selectedRepo}.`,
      ...
      'Visit <a href="https://github.com/gitrules/gitrules" target="_blank" rel="noreferrer">https://github.com/gitrules/gitrules</a>',
      'for documenation on how to manage GitRules community repos.',
    ].join(' ')
    console.log(message)
      ...
      {successMessage === '' && (
        <div>
          ...
          >
            ...
            Deploy GitRules for {selectedOrg}/{selectedRepo}
          </Button>
        </div>
      )}
      {successMessage !== '' && (
