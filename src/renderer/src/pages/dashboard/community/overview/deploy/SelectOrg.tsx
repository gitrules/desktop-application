  ...
  return (
    <>
      <MessageBar layout="multiline" intent="info">
        <MessageBarBody>
          GitRules communities can only be deployed for{' '}
          <a
          ...
          . You must be an admin of an organization in order to deploy a
          GitRules community. Listed below are the organizations this app is
          authorized to access and in which you are an admin. If Organizations
          you wish to manage are missing from the list, you may{' '}
